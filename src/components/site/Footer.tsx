    ...
    <footer id="workshop" className="relative bg-ink text-bone">
      <div className="mx-auto max-w-[1600px] px-6 py-20 md:px-10 md:py-28">
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-12 md:col-span-6">
            <h2 className="font-display text-6xl md:text-[10rem] leading-[0.85]">
              Vieni a<br /><span className="italic text-bone/60">trovarci.</span>
            </h2>
          </div>
          <div className="col-span-12 grid grid-cols-2 gap-8 text-sm md:col-span-6">
            <div>
            ...
            <div>
              ...
              <p>Lun &mdash; Sab<br />09:00 / 13:00<br />15:00 / 19:30</p>
            </div>
            <div>
              <div className="mb-3 text-xs uppercase tracking-[0.3em] text-bone/50">Contatti</div>
              <a href="mailto:info@turinbike.com" className="block hover:opacity-70">info@turinbike.com</a>
              <a href="tel:+390110000000" className="block hover:opacity-70">+39 011 000 0000</a>
            </div>
            <div>
              <div className="mb-3 text-xs uppercase tracking-[0.3em] text-bone/50">Social</div>
              <a className="block hover:opacity-70" href="#">Instagram</a>
              <a className="block hover:opacity-70" href="#">Facebook</a>
              <a className="block hover:opacity-70" href="#">YouTube</a>
            </div>
          </div>
        </div>
        ...
        <div className="mt-20 flex flex-col items-start justify-between gap-4 border-t border-bone/15 pt-8 text-xs uppercase tracking-[0.25em] text-bone/50 md:flex-row md:items-center">
          ...
          <span>45°03'53.3" N · 7°40'40.9" E</span>
        </div>
      </div>
    </footer>
  );
